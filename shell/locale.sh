...
LC_TIME=ru_RU.UTF-8           ls --help | head -1
LC_COLLATE=ru_RU.UTF-8        ls --help | head -1
LC_MONETARY=ru_RU.UTF-8       ls --help | head -1
LC_MESSAGES=ru_RU.UTF-8       ls --help | head -1
LC_PAPER=ru_RU.UTF-8          ls --help | head -1
LC_NAME=ru_RU.UTF-8           ls --help | head -1
LC_ADDRESS=ru_RU.UTF-8        ls --help | head -1
LC_TELEPHONE=ru_RU.UTF-8      ls --help | head -1
